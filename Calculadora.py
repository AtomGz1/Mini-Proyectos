...
class Calculadora:
    def __init__(self,main):
        ...
        Button(width=11,height=4,text="8",relief="flat",bg="white",command=lambda:self.mostrar(8)).place(x=180,y=275)
        Button(width=11,height=4,text="9",relief="flat",bg="white",command=lambda:self.mostrar(9)).place(x=90,y=275)
